...
if (startIndex !== -1 && endIndex !== -1) {
  const newContent = `          {/* Background Elements */}
          ...
          <div className="absolute inset-0 flex justify-center items-center pointer-events-none z-30 translate-x-4 md:translate-x-8">
            <motion.div
...
`;
  ...
  console.log('Successfully fixed buttons layout.');
} else {

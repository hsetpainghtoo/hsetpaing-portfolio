...
if (startIndex !== -1 && endIndex !== -1) {
  const newContent = `          {/* Background Elements */}
          ...
          <div className="relative w-full max-w-7xl mx-auto min-h-[85vh] flex flex-col justify-between p-6 md:p-12 z-20 pointer-events-none">
            {/* Top Left Information (ABOVE HSE) */}
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="self-start max-w-xs md:max-w-md pointer-events-auto mt-16 md:mt-12"
            >
            ...
            <motion.div
              ...
              className="self-end max-w-xs md:max-w-md pointer-events-auto text-right flex flex-col items-end mb-16 md:mb-12"
            >

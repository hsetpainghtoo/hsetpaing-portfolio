...
if (startIndex !== -1 && endIndex !== -1) {
  const newContent = `          {/* Background Elements */}
          ...
          <div className="relative w-full max-w-7xl mx-auto min-h-[90vh] flex flex-col justify-center items-center py-12 z-20 pointer-events-none">
            ...
            <motion.div
              ...
              className="w-full flex justify-start pl-4 md:pl-12 lg:pl-20 mb-2 md:mb-6 pointer-events-auto relative z-30"
            >
            ...
            <motion.div
              ...
              className="w-full flex justify-center items-center z-10 pointer-events-none relative"
            >
              <h1
                className={\`\${anton.className} text-[15vw] md:text-[20vw] text-gray-200/80 dark:text-white/5 tracking-wider leading-none whitespace-nowrap select-none uppercase\`}
              >
                Hset Paing
              </h1>
            </motion.div>
            ...
            <motion.div
              ...
              className="w-full flex justify-end pr-4 md:pr-12 lg:pr-20 mt-2 md:mt-6 pointer-events-auto relative z-30"
            >
              <div className="max-w-xs md:max-w-md text-right flex flex-col items-end">
